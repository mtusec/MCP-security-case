...
-   `server.py`: The server code containing critical security flaws.
-   `client.py`: A client application designed to run tests against both servers, demonstrating both the exploits and the effectiveness of the security patches.
